document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            project7_title: "Messi Cup (Estilo Viborita)",
            project7_desc: "Juego de la viborita temático de la Selección Argentina. Conduce a Messi para juntar Copas del Mundo y armar la fila de la Scaloneta con sus compañeros (Dibu, De Paul, Di María...). Cuenta con D-Pad en cruz y sonido retro.",
        ...
        en: {
            ...
            project7_title: "Messi Cup (Snake Style)",
            project7_desc: "Argentina national football team themed snake game. Guide Messi to collect World Cups and form the line of the 'Scaloneta' squad with his teammates (Dibu, De Paul, Di Maria...). Features cross D-Pad and retro sound.",
