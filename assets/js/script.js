document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            project7_title: "Messi Dribble Run (Dino Game)",
            project7_desc: "Juego interactivo 2D inspirado en el Chrome Dino. Controla a Messi para eludir defensores rivales y esquivar tarjetas. Cuenta con D-Pad, gestos táctiles y audio retro sintetizado.",
        ...
        en: {
            ...
            project7_title: "Messi Dribble Run (Dino Game)",
            project7_desc: "Interactive 2D game inspired by Chrome Dino. Control Messi to dribble past defenders and dodge referee cards. Features responsive physics, mobile D-Pad, swipe gestures, and synthesized retro audio.",
