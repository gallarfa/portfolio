document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            project7_title: "Messi Cup",
            project7_desc: "Juego de carrera infinita (Dino Runner) temático de Messi. Esquiva defensores rivales saltando con físicas de salto variable y recolecta Copas del Mundo para ganar el modo invencible.",
        ...
        en: {
            ...
            project7_title: "Messi Cup",
            project7_desc: "Messi-themed infinite runner game (Dino Runner). Dodge rival defenders by jumping with variable-height physics and collect World Cups to trigger invincible mode.",
